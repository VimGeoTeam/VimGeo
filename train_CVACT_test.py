...
from model.MambaGeo_cut_mapping_6144 import MambaGeo
from criterion.WBLossWithDynamicWeights import WBLossWithDynamicWeights
...
os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # 2 GPU
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    criterion = WBLossWithDynamicWeights().cuda(args.gpu)
